...
//can be included by having each component extend this one with 'extends: GenericPage'
//bad because you can only extend one class
// const GenericPage = Vue.component('GenericPage', {
//     props: {
        ...
        <div class="create page">
            ...
            <b-form v-if="loggedIn" @submit.prevent="addPotluck">
                <b-form-group label="Name" label-for="name" class="col-md-12">
                    <b-form-input id="name" v-model="newPotluck.name"  v-focus v-required="5"></b-form-input>
                </b-form-group>
                
                <b-form-group label="Date" label-for="date" class="col-md-6">
                    <b-form-input id="date" v-model="newPotluck.date" type="date" v-required:date.future></b-form-input>
                </b-form-group>
                
                <b-form-group label="Time" label-for="time" class="col-md-6">
                    <b-form-input id="time" v-model="newPotluck.time" type="time" v-required></b-form-input>
                </b-form-group>
                
                <b-form-group label="Location" label-for="location" class="col-md-12">
                    <b-form-input id="location" v-model="newPotluck.location" v-required></b-form-input>
                </b-form-group>
                
                <b-form-group label="Description" label-for="description" class="col-md-12">
                    <b-form-textarea id="description" v-model="newPotluck.description" rows="5" max-rows="5" v-required></b-form-textarea>
                </b-form-group>
